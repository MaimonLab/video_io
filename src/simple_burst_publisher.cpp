...
public:
        ...
        : Node("minimal_publisher")
    {
        ...
        timer_ = this->create_wall_timer(
            std::chrono::milliseconds(burst_interval_ms), std::bind(&MinimalPublisher::timer_callback, this));
        // std::chrono::seconds(burst_interval_s), std::bind(&MinimalPublisher::timer_callback, this));
    }
